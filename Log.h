...
// #define SLOG_FATAL( ... ) ::SandServer::Log_t::GetCoreLogger()->fatal(
// __VA_ARGS__ )
#define SLOG_FATAL( ... )                                                      \
   SPDLOG_LOGGER_CALL( ::SandServer::Log_t::GetCoreLogger(),                   \
                       spdlog::level::critical, __VA_ARGS__ )

//#define SLOG_ERROR( ... )                                                      \
//   SPDLOG_LOGGER_ERROR( ::SandServer::Log_t::GetCoreLogger(), __VA_ARGS__ )
#define SLOG_ERROR( ... )                                                      \
   ::SandServer::Log_t::GetCoreLogger()->error( __VA_ARGS__ )
//#define SLOG_WARN( ... )                                                       \
//   SPDLOG_LOGGER_WARN( ::SandServer::Log_t::GetCoreLogger(), __VA_ARGS__ )
#define SLOG_WARN( ... )                                                       \
   ::SandServer::Log_t::GetCoreLogger()->warn( __VA_ARGS__ )
//#define SLOG_INFO( ... )                                                       \
...
#define SLOG_TRACE( ... )                                                      \
   ::SandServer::Log_t::GetCoreLogger()->trace( __VA_ARGS__ )
